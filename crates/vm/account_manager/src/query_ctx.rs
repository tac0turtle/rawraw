    ...
    for QueryContext<'b, 'a, CM, ST, CALL_STACK_LIMIT>
{
    ...
    fn invoke_query<'c>(
        ...
        let handler_id =
            get_account_handler_id(self.state_handler, target_account, self.gas_stack.meter(), allocator)?
    ...
    QueryContext<'b, 'a, CM, ST, CALL_STACK_LIMIT>
{
    ...
    unsafe fn handle_get_handler_id<'c>(
        ...
        let handler_id = get_account_handler_id(self.state_handler, account_id, self.gas_stack.meter(), allocator)?
            .ok_or(SystemCode(AccountNotFound))?;
